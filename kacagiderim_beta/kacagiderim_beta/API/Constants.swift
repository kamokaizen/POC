...
//        static let baseURL = "http://127.0.0.1:4000"
    ...
    struct APIParameterKey {
        ...
        static let accountVehicleId = "accountVehicleId"
        static let vehicleDetailId = "vehicleDetailId"
        static let customVehicle = "customVehicle"
        static let vehiclePlate = "vehiclePlate"
        static let vehicleUsage = "vehicleUsage"
        static let vehicleBrand = "vehicleBrand"
        static let vehicleModel = "vehicleModel"
        static let vehicleDescription = "vehicleDescription"
        static let customConsumption = "customConsumption"
        static let customConsumptionType = "customConsumptionType"
