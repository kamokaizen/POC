...
class MapLocationSelectorVC : CardPartsFullScreenViewController, GMSMapViewDelegate {
    
//    var viewModel: MapLocationSelectorVM!
...
//    weak var delegate: LocationUpdateDelegate? = nil
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
//        self.viewModel = MapLocationSelectorVM(home: CLLocationCoordinate2D(), work: CLLocationCoordinate2D())
