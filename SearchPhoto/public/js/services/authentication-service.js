angular.module('customerportal').factory('Authentication', function (CallService, $cookies) {
	...
	return {
        ...
        setRemember: function (username, password) {
            $cookies.put("rmmbrm", JSON.stringify({ "username": username, "password": password, "check": true }));
        },
        removeRemember: function () {
            delete $cookies.remove("rmmbrm");
        },
        isRemember: function () {
            return $cookies.getObject("rmmbrm");
        }
	};
});